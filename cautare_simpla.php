...
echo "<h3> Cu plecare din: " . ucfirst($statie_plecare) . "</br></h3>";
$res = $mysql->query("select id_tren, statie_plecare, ora_plecare, statie_sosire, ora_sosire from drumuri where statie_plecare like '$statie_plecare%' and statie_sosire like '$statie_sosire%' order by ora_plecare");
$string=          
...
<div class="jumbotron text-center">
<?php
echo "<h3> Cu plecare din: " . ucfirst($statie_sosire) . "</br></h3>";
$res = $mysql->query("select id_tren, statie_plecare, ora_plecare, statie_sosire, ora_sosire from drumuri where statie_plecare like '$statie_sosire%' and statie_sosire like '$statie_plecare%' order by ora_plecare");
$string=          
  '<table class="table table-striped table-hover table-responsive table-bordered">
    <thead>
      <tr>
...
var center_latitude = (iasi_latitude + bacau_latitude) / 2;
var center_longitude = (iasi_longitude + bacau_longitude) / 2;
